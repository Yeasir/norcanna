...
<div class="wrapper">
 ...
 <header class="header">
        ...
        <div class="inner-header" <?php
        $background = get_field('page_background_image','option');
        if($background){?>
            style="background-image: url('<?php echo $background?>'); background-repeat: no-repeat; background-position: center;"
        <?php  } ?>>
                ...
                <div class="row pt-5">
                    <div class="col-12 text-center">
                        ...
                        if(is_page()){
                            ...
                            echo  "<h3 class=\"white-color\">".$parent_title . " </h3> ";
                        }
                        ?>
