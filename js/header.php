        ...
        <div class="mini-cart">
            <div class="mini-cart-wrapper">
                ...
                <div class="d-flex align-items-md-center">
                    <!-- /.cart-icon start -->
                    <div class="cart-icon">
                        <a href="#" class="cart-content position-relative text-uppercase">
                            <span class="contcon"></span>
                            ...
                            <span class="product-items-count"><span class="items-count">0</span> product</span>
                        </a>
                    </div>
                    <!-- /.cart-icon end -->
                ...
                <div class="cart-footer d-flex align-items-center mt-4">
                    ...
                    <?php if(!empty($items)){?>
                    <a href="<?php echo get_permalink( wc_get_page_id( 'checkout' ) );?>" class="btn orange text-uppercase ml-lg-auto ml-sm-auto ml-auto mt-2">CHECKOUT</a>
                    <?php };?>
                </div>
                <!-- /.cart-footer end -->
            </div>
